...
final verifiedPricesStreamProvider = StreamProvider<List<Map<String, dynamic>>>(
  (ref) {
...
final leaderboardStreamProvider = StreamProvider<List<Map<String, dynamic>>>((
  ref,
) {
  return FirebaseFirestore.instance
      .collection('users')
...
final userManagementServiceProvider = Provider<UserManagementService>(
