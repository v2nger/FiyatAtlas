...
void main() {
  ...
  group('Confidence Engine Test (VerificationService)', () {
    test(
      'Basic entry without receipt should likely be Pending (Score < 60)',
      () async {
        ...
        final updated = repository.getEntries().firstWhere(
          (e) => e.id == 'test_1',
        );
    ...
    test('Entry with receipt AND trusted user AND peers should verify', () async {
      ...
      final entry = PriceEntry(
        id: 'test_3',
        userId:
            'user_trusted', // Will assume even hash or close enough for high score
        barcode: '8690003',
        marketBranchId: 'market_3',
        price: 100.0,
        currency: 'TRY',
