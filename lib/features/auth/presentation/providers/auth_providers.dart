...
final currentUserProvider = AsyncNotifierProvider<CurrentUserNotifier, User?>(CurrentUserNotifier.new);
  ...
  Future<User> _fetchOrCreateUser(fb_auth.User firebaseUser) async {
    ...
    if (user == null) {
      ...
      user = User(
        ...
        avatarUrl: firebaseUser.photoURL ?? 'https://i.pravatar.cc/300?img=${firebaseUser.uid.hashCode % 70}',
...
// Auth Controller for generic actions
